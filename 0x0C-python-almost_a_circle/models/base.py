...
class Base:
    ...
    def draw(list_rectangles, list_squares):
        ...
        julien = turtle_module.Turtle()
        julien.screen.bgcolor("#7c8691")
        julien.pensize(3)
        julien.shape("turtle")
        ...
        for rect in list_rectangles:
            julien.showturtle()
            julien.up()
            julien.goto(rect.x, rect.y)
            julien.down()
            for i in range(2):
                julien.forward(rect.width)
                julien.left(90)
                julien.forward(rect.height)
                julien.left(90)
            julien.hideturtle()
        ...
        for sq in list_squares:
            julien.showturtle()
            julien.up()
            julien.goto(sq.x, sq.y)
            julien.down()
            for i in range(2):
                julien.forward(sq.width)
                julien.left(90)
                julien.forward(sq.height)
                julien.left(90)
            julien.hideturtle()
